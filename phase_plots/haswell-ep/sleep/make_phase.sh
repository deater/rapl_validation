...
/home/vince/research/linux-kernel/linux-4.1.5/tools/perf/perf stat -a -e power/energy-ram/ -I 100 -x , ./run_test.sh 2> sleep.perf.phase 1> sleep.stdio.phase ; done
