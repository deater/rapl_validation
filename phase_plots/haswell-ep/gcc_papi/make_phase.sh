...
/home/vince/research/linux-kernel/linux-4.1.5/tools/perf/perf stat -a -e power/energy-ram/ -I 100 -x , make -j4  2> gcc_papi.perf.phase 1> gcc_papi.stdio.phase ; done ; make clean
