...
/home/vince/research/linux-kernel/linux-4.1.5/tools/perf/perf stat -a -e power/energy-ram/ -I 100 -x , /home/vince/research/power-measurement/power_benchmarks/stream-5.10/stream_omp 2> stream.perf.phase 1> stream.stdio.phase ; done
